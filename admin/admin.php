				...
				case 'boolean': {
					...
					if ( isset( $args['plugintocheck'] ) && ( $args['plugintocheck'] != '' ) ) {
						if ( is_plugin_active( $args['plugintocheck'] ) ) {
							...
							echo '<br />' . sprintf( __( 'This plugin (%s) is <strong class="gtm4wp-plugin-not-active">not active</strong>, enabling this integration could cause issues on frontend!', 'duracelltomi-google-tag-manager' ) , $args['plugintocheck']);
						}
					}
